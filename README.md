# 拉取命令：
## 平行容器：
### ql repo https://github.com/wjx0428/jd_script.git "opencard|redPacket|jxlhb|SplitRedPacket|jxsign|zjb|yqyl|openCard|fcdyj|city|hyj|bean_change|selectionOffice|lol|jika|fcdyj|zzt|big|CheckCK|jd_red|aid|fcwb|angryBean|hotnight" "activity|backUp" "^jd[^_]|USER|utils|function|ql"
